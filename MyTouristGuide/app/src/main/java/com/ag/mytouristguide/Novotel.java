    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoUrl("https://goo.gl/maps/3Y8HrAemoLdnqEVD8");
        ...
        goibibo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.goibibo.com/hotels/novotel-ahmedabad-hotel-in-ahmedabad-6952601382498905020/");
        ...
        tripadvisor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.tripadvisor.in/Hotel_Review-g297608-d5001420-Reviews-Novotel_Ahmedabad_Hotel-Ahmedabad_Ahmedabad_District_Gujarat.html");
        ...
        makemytrip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.makemytrip.com/hotels/novotel_ahmedabad-details-ahmedabad.html");
